...
export default async function ListingPage({ params }: Props) {
  ...
  // BreadcrumbList JSON-LD (SEPARATE block — the Physician object above is untouched).
  // City-only-root: trail is Home → /{citySlug} hub → business, where the city crumb
  // is included only when the listing's city resolves to a configured city hub
  // (getRegionBySlug) so the emitted URL always 200s; otherwise Home → business.
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-500">Run a different pediatrician{listing.city ? ` in ${listing.city}` : ""}? <Link href="/list-your-business" className="underline" style={{ color: verticalConfig.primaryColor }}>Add your business &rarr;</Link></p></>
